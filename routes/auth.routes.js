...
// On importe les bonnes fonctions de notification
...
router.post('/register', async (req, res) => {
    try {
        ...
        // --- CORRECTION : On utilise les nouvelles fonctions de notification ---
        // Elles sont plus simples et gèrent tout correctement.
