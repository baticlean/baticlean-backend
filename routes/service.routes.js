...
router.post('/', isAuthenticated, isAdmin, async (req, res) => {
  try {
    ...
    // On notifie tout le monde qu'un nouveau service a été créé
...
router.put('/:id', isAuthenticated, isAdmin, async (req, res) => {
  try {
    ...
    // On notifie tout le monde que le service a été mis à jour
...
router.delete('/:id', isAuthenticated, isAdmin, async (req, res) => {
  try {
    ...
    // On notifie tout le monde qu'un service a été supprimé
